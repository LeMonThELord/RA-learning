...
sources = {
    "cuda-self":["total-cuda.csv", "overhead-cuda.csv"],
    "shared-self":["total-shared.csv", "overhead-shared.csv"],
    "cuda-shared":["total-shared.csv", "total-cuda.csv"],
    "cuda-shared-arranged":["total-shared.csv","total-arranged.csv", "total-cuda.csv"],
}
...
if __name__ == "__main__":
    ...
    ppt_plot("cuda-self", smoothed=True, figsize=(7, 7))
    ppt_plot("shared-self", smoothed=True, figsize=(7, 7))
    ppt_plot("cuda-shared", smoothed=True, figsize=(7, 7))
    ppt_plot("cuda-shared-arranged", smoothed=True, figsize=(7, 7))
