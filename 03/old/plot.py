...
csv_dir = current_dir / "consolidate data"
plot_dir = current_dir / "plots"

sources = {
    "fix-cuda-row":["total-row-cuda-old-16.csv", "total-row-cuda-16.csv", "total-pthread-16.csv", "total-cuda.csv"],
}
...
if __name__ == "__main__":
    ...
    ppt_plot("fix-cuda-row", smoothed=True, data_range=(0, 500), figsize=(7, 7))
